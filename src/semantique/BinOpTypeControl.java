    ...
    public int control() {
        ...
        if (this.ast instanceof Plus) {
            ...
            if (((Plus) this.ast).left instanceof Lvalue
                ...
                if (type_left != null) {
                    nb_error++;
                    System.out
                            .println("Error: Plus must have two operands of the same type at line "
                                    + this.ligne);
        ...
        if (this.ast instanceof Minus) {
            ...
            if (((Minus) this.ast).left instanceof Lvalue
                ...
                if (type_left != null) {
                    nb_error++;
                    System.out
                            .println("Error: Minus must have two operands of the same type at line "
                                    + this.ligne);
        ...
        if (this.ast instanceof Mult) {
            ...
            if (((Mult) this.ast).left instanceof Lvalue
                ...
                if (type_left != null) {
                    nb_error++;
                    System.out
                            .println("Error: Mult must have two operands of the same type at line "
                                    + this.ligne);
        ...
        if (this.ast instanceof Div) {
            ...
            if (((Div) this.ast).left instanceof Lvalue
                ...
                if (type_left != null) {
                    nb_error++;
                    System.out.println("Error: Div must have two operands of the same type at line "
                            + this.ligne);
